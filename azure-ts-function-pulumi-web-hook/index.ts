...
const app = new web.WebApp("fa", {
    ...
    siteConfig: {
        appSettings: [
            { name: "FORCE_WEBAPP_UPDATE", value: pulumi.interpolate`${codeBlob.contentMd5}`}, // this value has no use other than to force Pulumi to do an update of the webapp when the handler code changes
...
export const endpoint = pulumi.interpolate`https://${app.defaultHostName}/api/SlackHandler`;
